...
/**
 * https://github.com/mylesmmurphy/prettify-ts/blob/main/packages/typescript-plugin/src/type-tree/get-ast-node.ts
    ...
    for (const child of children) {
      if (child.kind !== typescript.SyntaxKind.SyntaxList) {
        ...
        const isEndOfFileToken =
          child.kind === typescript.SyntaxKind.EndOfFileToken
        const hasSameStart =
